        ...
        <div className="flex justify-center items-center">
          <div>
            <input
              type="text"
              placeholder="search"
              className="text-2xl text-black w-[600px] h-12 outline-none border-grey-200 border-2 rounded-l-full px-6"
            />
          </div>
          <div className="bg-gray-50 hover:bg-gray-100 h-12 w-24 flex justify-center items-center rounded-r-full border-grey-200 border-2 border-l-0  cursor-pointer">
            <img src={search_icon} className="h-6" />
          </div>
        </div>
        <div className="flex gap-6 mx-10">
          <span className="hover:bg-gray-100 hover:rounded-full h-12 w-12 items-center flex justify-center cursor-pointer">
            <img src={upload_icon} className="h-8" />
          </span>
          <span className="hover:bg-gray-100 hover:rounded-full h-12 w-12 items-center flex justify-center cursor-pointer">
            <img src={notify_icon} className="h-8" />{" "}
          </span>
          <span className="items-center flex justify-center cursor-pointer">
